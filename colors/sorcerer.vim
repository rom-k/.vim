...
" 256 Colors {{{1
" ============================================================================
hi Normal                 cterm=NONE             ctermfg=145
...
hi ErrorMsg               cterm=bold                 ctermfg=203
...
hi NonText                cterm=NONE                ctermfg=59
...
hi Title                  cterm=bold                 ctermfg=66
...
hi Comment                cterm=NONE                 ctermfg=65
hi Boolean                cterm=NONE                 ctermfg=208
hi String                 cterm=NONE                 ctermfg=101
hi Identifier             cterm=NONE                 ctermfg=145
hi Function               cterm=NONE                 ctermfg=230
hi Type                   cterm=NONE                 ctermfg=103
hi Statement              cterm=NONE                 ctermfg=110
hi Keyword                cterm=NONE                 ctermfg=110
hi Constant               cterm=NONE                 ctermfg=208
hi Number                 cterm=NONE                 ctermfg=172
hi Special                cterm=NONE                 ctermfg=64
hi PreProc                cterm=NONE                 ctermfg=66
hi Todo                   cterm=bold,underline   ctermbg=234   ctermfg=96

hi diffOldFile            cterm=NONE                 ctermfg=67
hi diffNewFile            cterm=NONE                 ctermfg=67
hi diffFile               cterm=NONE                 ctermfg=67
hi diffLine               cterm=NONE                 ctermfg=67
hi diffAdded              cterm=NONE             ctermfg=235    ctermfg=71
hi diffRemoved            cterm=NONE             ctermfg=235    ctermfg=124
hi diffChanged            cterm=NONE             ctermfg=235    ctermfg=68
hi link             diffSubname     diffLine
hi link             diffOnly        Constant
hi link             diffIdentical   Constant
hi link             diffDiffer      Constant
...
hi pythonClass            cterm=NONE                 ctermfg=fg
hi pythonDecorator        cterm=NONE                 ctermfg=101
hi pythonExClass          cterm=NONE                 ctermfg=95
hi pythonException        cterm=NONE                 ctermfg=110
hi pythonFunc             cterm=NONE                 ctermfg=fg
hi pythonFuncParams       cterm=NONE                 ctermfg=fg
hi pythonKeyword          cterm=NONE                 ctermfg=fg
hi pythonParam            cterm=NONE                 ctermfg=fg
hi pythonRawEscape        cterm=NONE                 ctermfg=fg
hi pythonSuperclasses     cterm=NONE                 ctermfg=fg
hi pythonSync             cterm=NONE                 ctermfg=fg
...
hi Test                   cterm=NONE                 ctermfg=fg
hi Underlined             cterm=underline            ctermfg=111
hi VisualNOS              cterm=bold,underline       ctermfg=fg
hi cCursor                cterm=reverse              ctermfg=fg
